...
namespace LPA.Data.Migrations
{
    ...
    [Migration("20231023113728_Update_Link_Competition_Phase_Rencontre")]
    partial class Update_Link_Competition_Phase_Rencontre
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LPA.Models.Domains.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LPA.Models.Domains.Competition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPA.Models.Domains.Equipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPA.Models.Domains.Lieu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPA.Models.Domains.Phase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPA.Models.Domains.Pronostic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPA.Models.Domains.Rencontre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPA.Models.Domains.Tournoi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationUserTournoi", b =>
                {
                    b.HasOne("LPA.Models.Domains.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("ApplicationUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LPA.Models.Domains.Tournoi", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CompetitionEquipe", b =>
                {
                    b.HasOne("LPA.Models.Domains.Competition", null)
                        .WithMany()
                        .HasForeignKey("CompetitionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LPA.Models.Domains.Equipe", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LPA.Models.Domains.Competition", b =>
                {
                    b.HasOne("LPA.Models.Domains.Lieu", "Lieu")
            ...
            modelBuilder.Entity("LPA.Models.Domains.Phase", b =>
                {
                    b.HasOne("LPA.Models.Domains.Competition", "Competition")
                        .WithMany("Phases")
            ...
            modelBuilder.Entity("LPA.Models.Domains.Pronostic", b =>
                {
                    b.HasOne("LPA.Models.Domains.ApplicationUser", "ApplicationUser")
                        .WithMany("Pronostics")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LPA.Models.Domains.Rencontre", "Rencontre")
                        .WithMany("Pronostics")
            ...
            modelBuilder.Entity("LPA.Models.Domains.Rencontre", b =>
                {
                    b.HasOne("LPA.Models.Domains.Equipe", "EquipeDomicile")
                        .WithMany()
                        .HasForeignKey("EquipeDomicileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LPA.Models.Domains.Equipe", "EquipeExterieur")
                        .WithMany()
                        .HasForeignKey("EquipeExterieurId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LPA.Models.Domains.Phase", "Phase")
                        .WithMany("Rencontres")
